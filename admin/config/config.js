...
( function(winkstart, amplify, $) {
    ...
    winkstart.config =  {
        ...
        ws_server: 'wss://67.227.80.84:8080',
            ...
            'default': {
                apps: {
                    voip: {
                        label: 'Hosted PBX',
                        icon: 'phone',
                        api_url: 'http://67.227.80.84:8000/v1'
                    },
                    pbxs: {
                        label: 'PBX Connector',
                        icon: 'device',
                ...
                default_api_url: 'http://67.227.80.84:8000/v1'
            },
            'reseller': {
                apps: {
                    voip: {
        ...
        /* Custom links */
        nav: {
            help: 'http://www.velantro.com',
            learn_more: 'http://www.velantro.com/'
        },

        default_api_url: 'http://67.227.80.84:8000/v1',
        default_api_v2_url: 'https://my.velantro.com:8443/v2',
